        ...
        <div class="inline-block overflow-hidden text-left align-middle transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:max-w-lg sm:w-full" role="dialog" aria-modal="true" aria-labelledby="modal-headline">
            ...
            <form>
                <div class="px-3 pt-1 pb-3 bg-white sm:p-6 sm:pb-4">
                    ...
                    <div>
                        <div class="px-1 py-2">
                            <input wire:model="idlibur" type="hidden" class="w-full px-2 py-2 border rounded shadow appearance-non" id="idlibur" >
                        ...
                        <div class="py-2">
                            <input wire:model.defer="jumlah" type="text" class="w-1/3 px-2 py-2 ml-4 border rounded shadow appearance-non" id="jumlah" autocomplete="off" placeholder="Jumlah" readonly>
                            @error('jumlah')
                            <h1 class="text-red-500">{{ $message }}</h1>
                            @enderror
                            <input wire:model.defer="keterangan" type="text" class="w-1/3 px-2 py-2 ml-4 border rounded shadow appearance-non" id="keterangan" autocomplete="off" placeholder="keterangan">
                            @error('keterangan')
                            <h1 class="text-red-500">{{ $message }}</h1>
                            @enderror
                        </div>
